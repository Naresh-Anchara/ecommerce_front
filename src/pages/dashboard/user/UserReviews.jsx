...
const UserReviews = () => {
    ...
    const {data : reviewdata,error,isLoading} = useGetReviewsByUserIdQuery(user?._id);
  ...
  return (
    <div className='py-6'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mt-8 gap-8'>
        ...
        className='bg-gray-100 text-black flex items-center justify-center 
        rounded-lg p-6 border cursor-pointer hover:bg-primary hover:text-white
